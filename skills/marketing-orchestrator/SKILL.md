...
|---|---|---|---|
| **Sellers** | Founder-operators ($1M-$20M revenue) | ExitFit Diagnostic | social-content-capital8, copywriting, cold-email, email-sequence, page-cro, seo-audit, ai-seo |
| **Buyers** | Acquirers / capital allocators ($5M-$100M+ dry powder) | Mandate Desk access | social-content-capital8 (PEER mode), cold-email, sales-enablement |
...
**Skills invoked:** email-sequence, churn-prevention, referral-program
**Actions:**
- Build or optimise email sequences (post-diagnostic nurture, Mandate Desk onboarding, dealmaker activation)
...
**Purpose:** Arm Sven with materials for live conversations.
**Skills invoked:** sales-enablement, revops, launch-strategy
**Actions:**
- Create or update pitch decks, one-pagers, objection docs
...
**Output:** Sales materials and RevOps recommendations written to sprint file.
...
| Email sequences (nurture, onboarding) | email-sequence |
...
- **All 34 skills in the repo** — This orchestrator can invoke any of them based on task requirements
